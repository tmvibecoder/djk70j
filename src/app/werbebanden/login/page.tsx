...
function LoginForm() {
  ...
  const next = params.get('next') || '/werbebanden'
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError(null)
    setLoading(true)
    const res = await fetch('/api/werbebanden/auth/login', {
      method: 'POST',
    ...
    router.push(next.startsWith('/werbebanden') ? next : '/werbebanden')
    router.refresh()
  }
  ...
  return (
    ...
    >
      <div className="text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mt-1">🏟️ Bandenwerbung</h1>
...
export default function BandenLoginPage() {
  return (
