...
interface LoginNutzer {
  username: string
  name: string
}

function LoginFormInner({ nutzer }: { nutzer: LoginNutzer[] }) {
  ...
  return (
    ...
    >
      ...
      <div className="space-y-3">
        <div>
          <label className="block text-xs font-semibold text-gray-700 uppercase mb-1">Benutzer</label>
          <select
            value={username}
...
export function LoginForm({ nutzer }: { nutzer: LoginNutzer[] }) {
  return (
