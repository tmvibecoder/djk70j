...
- **Dauerhafte Bereiche** (unabhängig von Veranstaltungen, je eigener Login):
  `/werbebanden` (Bandenwerbung am Sportplatz) und `/djk-info` (Vereinszeitschrift:
  Anzeigenkunden, Rechnungen, Ausgaben, Heft-Verteilung mit DIN-A4-PDFs)
...
npm run db:seed:djk-info         # DJK-Info-Startdaten (Kunden, Verteilung, Rollen-Passwörter)
